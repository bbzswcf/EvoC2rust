...
if __name__ == "__main__":
    ...
    for project_name in projects:          
        ...
        cache_0 = ProjectCache(config, cache_dir="./data/increment/cache/evo-c2rust-v2-ds-gen-only")
        cache_1 = ProjectCache(config, cache_dir="./data/increment/cache/evo-c2rust-v2-ds-delim-fix")
        cache_2 = ProjectCache(config, cache_dir="./data/increment/cache/evo-c2rust-v2-ds-rule-fix")
        cache_3 = ProjectCache(config, cache_dir="./data/increment/cache/evo-c2rust-v2-ds-llm-repair")
