...
if __name__ == "__main__":
    ...
    old_cache = ProjectCache(config, cache_dir="./data/default/cache/evo-c2rust-v2-ds-gen-only")
    new_cache = ProjectCache(config, cache_dir="./data/default/cache/evo-c2rust-v2-ds-delim-fix")
